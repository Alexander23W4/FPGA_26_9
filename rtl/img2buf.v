...
module img2buf #(
    ...
    output reg                   buf_en,
    output reg                   buf_we,
    output reg [ADDR_WIDTH-1:0]  buf_addr,
    output reg [DATA_WIDTH-1:0]  buf_din,

    output end_frame
);
    assign px_ready  = 1'b1;        // 一直收, 不给上游背压
